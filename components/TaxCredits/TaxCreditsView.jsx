    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
        <button
          ...
          className="p-4 border-2 rounded-lg text-left transition-all bg-white border-gray-200 hover:border-red-400 hover:shadow-md cursor-pointer group"
        >
          <img
            src="/flag-canada.svg"
            alt=""
          ...
          />
          <h3 className="text-sm font-semibold mb-1 text-gray-900 group-hover:text-red-600">
            Canada (Federal)
          </h3>
          <p className="text-xs text-gray-500">View tax credits →</p>
        </button>
      </div>
