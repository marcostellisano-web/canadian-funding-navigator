      ...
      <div>
        <div className="flex justify-between items-center mb-1">
          ...
          <button
            ...
            className={`px-4 py-2 rounded-lg transition-colors text-sm font-semibold shadow-sm ${compareMode ? 'bg-gray-100 text-gray-700 hover:bg-gray-200' : 'bg-[#ff5757] text-white hover:bg-[#e04545] ring-2 ring-[#ffaaaa]'}`}
          >
