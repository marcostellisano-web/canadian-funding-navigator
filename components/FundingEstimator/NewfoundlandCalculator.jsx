...
export default function NewfoundlandCalculator({
  creditType,
  setCreditType,
  provincialLabour,
  setProvincialLabour,
    ...
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4">
      <div className="space-y-1.5">
        ...
        <div>
          ...
          >
            <option value="labour">Film & Video Tax Credit (Labour Based)</option>
            <option value="allspend">All Spend Tax Credit</option>
          </select>
        </div>
        ...
        {creditType === 'labour' && (
          <div>
            <label className="block text-sm font-normal text-gray-900 mb-0.5">
              Newfoundland labour expenditures
              <InfoIcon tooltip="Eligible labour paid to residents of Newfoundland & Labrador. Credit is capped at 25% of total production budget." />
            </label>
        ...
        {creditType === 'allspend' && (
          <div>
            <label className="block text-sm font-normal text-gray-900 mb-0.5">
              ...
              <InfoIcon tooltip="All qualifying production expenditures incurred in Newfoundland & Labrador." />
            </label>
            <div className="relative">
              <span className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-900 text-sm">$</span>
              <input
