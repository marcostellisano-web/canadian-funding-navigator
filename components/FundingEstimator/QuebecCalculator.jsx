...
export default function QuebecCalculator({
  creditType,
  setCreditType,
  provincialLabour,
  setProvincialLabour,
    ...
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4">
      <div className="space-y-1.5">
        ...
        <div>
          ...
          >
            <option value="production">SODEC Production Tax Credit (32%)</option>
            <option value="service">SODEC Production Services Tax Credit (25%)</option>
          </select>
        </div>

        {/* Production Credit - Quebec Labour Input */}
        {creditType === 'production' && (
          <div>
            <label className="block text-sm font-normal text-gray-900 mb-0.5">
              Quebec labour expenditures
              <InfoIcon tooltip={`All labour performed in Quebec regardless of residency is eligible. Capped at 65% of budget${budget > 0 ? ` ($${labourCap.toLocaleString(undefined, {maximumFractionDigits: 0})})` : ''}.`} />
            </label>
        ...
        {/* Service Credit - Production Expenditures Input */}
        {creditType === 'service' && (
          <div>
            <label className="block text-sm font-normal text-gray-900 mb-0.5">
              Qualifying production expenditures in Quebec
              <InfoIcon tooltip="All qualifying production expenditures incurred in Quebec. Production cost must exceed $250,000." />
            </label>
            <div className="relative">
              <span className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-900 text-sm">$</span>
              <input
        ...
        {creditType === 'production' && (
          <div className="mt-2 p-2.5 bg-blue-50 rounded-lg border border-blue-100">
            ...
            <ul className="text-xs text-blue-700 space-y-0.5 list-disc list-inside">
              <li>A minimum of 75% of goods and services must be spent on Quebec expenditures</li>
              <li>All labour performed in Quebec regardless of residency is considered eligible</li>
              <li>Eligible labour maximum is 65% of the budget</li>
            </ul>
          </div>
        )}
        ...
        {creditType === 'service' && (
          <div className="mt-2 p-2.5 bg-blue-50 rounded-lg border border-blue-100">
            <p className="text-xs font-medium text-blue-800 mb-1">Requirements:</p>
            <ul className="text-xs text-blue-700 space-y-0.5 list-disc list-inside">
              <li>Available if a project does not qualify for the production tax credit</li>
              <li>The cost of the production must exceed $250,000</li>
            </ul>
          </div>
        )}
