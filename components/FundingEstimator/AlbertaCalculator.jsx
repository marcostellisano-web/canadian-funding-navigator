...
export default function AlbertaCalculator({
  creditType,
  setCreditType,
    ...
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4">
      <div className="space-y-1.5">
        ...
        <div>
          ...
          >
            <option value="base">FTTC - Base Rate (22%)</option>
            <option value="enhanced">FTTC - Enhanced Rate (30%)</option>
          </select>
        </div>
        ...
        <div>
          <label className="block text-sm font-normal text-gray-900 mb-0.5">
            ...
            <InfoIcon tooltip="Eligible production expenditures incurred in Alberta. Minimum $499,999 total production costs required." />
          </label>
        ...
        {creditType === 'enhanced' && (
          <div className="mt-2 p-2.5 bg-blue-50 rounded-lg border border-blue-100">
            <p className="text-xs font-medium text-blue-800 mb-1">Additional requirements for 30% rate:</p>
            <ul className="text-xs text-blue-700 space-y-0.5 list-disc list-inside">
              <li>At least 50% project ownership by Alberta individuals</li>
              <li>Alberta-based producer with single card credit</li>
              <li>Copyright held by Alberta-based entity</li>
              <li>60% eligible production costs OR 70% Alberta labour costs</li>
            </ul>
          </div>
        )}
